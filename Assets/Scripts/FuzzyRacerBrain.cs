...
public class FuzzyRacerBrain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Fill fuzzy variables with their membership functions ----------------------------------
        // Distance
    ...
    void Update()
    {
        ...
        // Transform into fuzzy range of values
        ...
        // Save outputs of fuzzy rules into degrees for the output variable's membership functions ---------
        ...
        // Calculate the centroids for the membership functions of the output variable and average them-----------------------
